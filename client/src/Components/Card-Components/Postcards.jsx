...
const Postcards = ({ index, image, title, description }) => {
    return (
        ...
        <section className="my-4 text-gray-600 body-font overflow-hidden shadow-lg lg:max-w-[1200px]">
            <div className="container pt-4 pb-10 mx-auto w-[100%] ">
                <div className="inner md:w-full w-[80%] mx-auto grid grid-flow-row content-center justify-items-center lg:flex lg:justify-center lg:items-center gap-40 ">
